...
export const FileHistory = () => {
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute("download", `file-upload-scans-${new Date().toISOString()}.csv`);
  ...
  const exportToJSON = () => {
    ...
    link.setAttribute("download", `file-upload-scans-${new Date().toISOString()}.json`);
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  };
  ...
  return (
    <div className="container mx-auto px-6 py-6">
      <h2 className="text-2xl font-bold text-center mb-4 text-gray-900">File Upload Scan History</h2>
