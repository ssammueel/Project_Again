...
export const Register = () => {
  ...
  return (
    <div className='flex justify-center p-5 mt-20'>
      <form action="" className='bg-slate-300 flex flex-col p-3 gap-3 w-[30%] rounded' onSubmit={handleSubmit}>
        ...
        Password :
        <input id='passwordInput' className='bg-white p-2 indent-3 outline-none rounded-btn'
          type='password' name='password' value={userDetails.password}
          placeholder='Enter Password'  onChange={handleInput}
          onKeyDown={(e) => handleKeyDown(e, document.getElementById('confirmInput'))}
        />

        Confirm :
        <input id='confirmInput' className='bg-white p-2 indent-3 outline-none rounded-btn'
          type='password' name='confirm' value={userDetails.confirm}
