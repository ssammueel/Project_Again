...
export const Register = () => {
  ...
  const handleInput = (e) => {
    ...
    setUserDetails(prev => ({ ...prev, [name]: processedValue }));
    ...
    <div className='flex justify-center p-5 mt-20'>
      <form className='bg-slate-300 flex flex-col p-6 gap-3 w-[30%] rounded-lg' onSubmit={handleSubmit}>
        ...
        <div className="relative">
          <input id='passwordInput' className='bg-white p-2 indent-3 outline-none rounded-btn w-full'
            type={showPassword ? "text" : "password"} name='password' value={userDetails.password} placeholder='Enter Password'
            onChange={handleInput} onKeyDown={(e) => handleKeyDown(e, document.getElementById('confirmInput'))}
          />
          <button 
            type="button" className="absolute right-3 top-2.5 text-gray-600 hover:text-gray-800" 
